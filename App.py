...
class ExpenseTracker(tk.Tk):
    def __init__(self):
        ...
        self.home_frame = tk.Frame(
            self, background=bg_color, width=w_width, height=w_height
        )
        self.home_frame.place(x=0, y=0)

        # Expense amount
        self.expense_amount_label = tk.Label(
            self.home_frame, text="Expense amount:", bg=bg_color, fg=bg_color1
        )
        ...
        # Item Description
        self.item_description_label = tk.Label(
            self.home_frame, text="Item Description:", bg=bg_color, fg=bg_color1
        )
        ...
        self.date_label = tk.Label(
            self.home_frame, text="Date:(YYYY-MM-DD)", bg=bg_color, fg=bg_color1
        )
        ...
        self.list_of_items_label = tk.Label(
            self.home_frame, text="List of items", bg=bg_color, fg=bg_color1
        )
        ...
        self.transactions_label = tk.Label(
            self.home_frame, text="Transactions:", bg=bg_color, fg=bg_color1
        )
        ...
        self.show_chart_button = tk.Button(
            ...
            bg=bg_color1,
            fg=bg_color,
            command=lambda: self.go_to_frame("Chart"),
        )
